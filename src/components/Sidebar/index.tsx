...
export function Sidebar({ isSidebarOpened }: SidebarProps) {
  return (
    <aside
      className={`overflow-hidden z-1 py-[calc(2.25rem+12px)] translate-y-[-12px] h-[calc(100vh-6rem+52px)]    flex flex-col bg-[#373737] rounded-br-xl ease-in-out duration-300 ${
